...
const wishlistItems = [
  ...
  },
  {
    ...
    originalPrice: 34.99,
    image:
      'https://images.unsplash.com/photo-1511707171639-5f57f1c5df89?w=300&h=300&fit=crop',
    inStock: true,
    rating: 4.3,
    reviewCount: 78,
...
const Wishlist = () => {
  ...
  // Move items to cart
  const moveToCart = (itemIds = selectedItems) => {
    setIsLoading(true);
    // In a real app, this would add items to the cart via API
    console.log('Moving to cart:', itemIds);
        ...
        <>
          ...
          <div className='grid gap-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4'>
            {sortedItems.map((item) => (
              <Card
                key={item.id}
                className={`group relative overflow-hidden transition-all duration-200 hover:shadow-lg dark:border-gray-700 dark:hover:shadow-gray-800/20 ${
                ...
                <div className='border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-4 py-3 sm:px-6'>
                    ...
                    <div className='flex space-x-2 w-full sm:w-auto'>
                      <Button
                        ...
                        onClick={() => {
                          ...
                          // For demo, we'll just remove it from the wishlist
                          setItems((prev) =>
                      ...
                      <Button
                        variant='outline'
                        size='sm'
                        className='w-1/2 sm:w-auto text-red-600 border-red-200 hover:bg-red-50 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-900/30'
                        onClick={() => {
                          // In a real app, this would remove from wishlist via API
                          setItems((prev) =>
                            prev.filter((i) => i.id !== item.id)
                          );
                        }}>
